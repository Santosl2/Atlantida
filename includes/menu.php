...
<div class="flex">
    ...
    <nav class="side-nav">
        ...
        <ul>
            <li>
                <a href="dashboard" class="side-menu  <?= Site::strContains($page, 'dashboard') ? 'side-menu--active' : "";?>">
            ...
            <li>
                <a href="produtos" class="side-menu <?= Site::strContains($page, 'produtos') ? 'side-menu--active' : "";?>">
